...
王・預言者・商人・ゴリラの4つの役割が場ごとに隣の席へ回り、札を重ねて最後に出した人が場を総取りする、
...
- 2〜4人。役割は **王・預言者・商人・ゴリラ** の4つで、場が終わるたびに時計回りに隣へ移る。1局は4つの場、4局で終わり
- 数字札は4スート（貨幣・聖典・冠・ゴリラ）× 1〜13 × 2枚。2人は1〜9、3人は1〜11を使う。ほかにバナナ4枚、シルバーバック1枚
- 出す順は **王→預言者→商人→ゴリラ**（空席は飛ばす）。王がリード（1枚・連番・同数。バナナは組の足りない1枚の代わり）
- 以降は順にぐるぐる回り、同じ形・同じ枚数で **同じ色の上の数字** か **同じ数字の色かえ** を重ねるか、パスして抜ける。**連番と同数は色を問わず、数字が上なら重ねられる**
- **最後に出した人が場の札を総取り**（役割に関係なく全部点）。得点札はゲームに戻らない。手札は場ごとに8枚まで補充
- 能力：王＝先導（リード）／預言者＝1人を指名して伏せて1枚ずつやりとり（シルバーバックは必ず渡す）、指名した人が取れば先に1枚／
  商人＝取れなかったら先に貨幣の最小1枚、貨幣なら色を問わず上げられる／ゴリラ＝色を問わず上げられる、シルバーバックで場を即座に取る

アプリでは、預言の「好きな1枚」はいちばん点の大きい札を自動で取る。
